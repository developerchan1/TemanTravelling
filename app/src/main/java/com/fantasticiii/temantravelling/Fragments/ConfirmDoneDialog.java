...
public class ConfirmDoneDialog extends DialogFragment {
    private MaterialButton btnTidak;
    private TextView tvYa;

    public ConfirmDoneDialog() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_dialog_confirm_done, container);
    }
        ...
        tvYa.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               //remove the progress from onProgress Collection
                ((TourGuideActivity) getActivity()).orderCompleted();
                getDialog().dismiss();
            }
        });
    }
